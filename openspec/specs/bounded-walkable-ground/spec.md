# bounded-walkable-ground Specification
...
Confinement MUST NOT change keyboard or joystick camera-relative mapping,
player speed tuning, camera controls, zone occupancy, or quest behavior.
Ground, border, and confinement behavior SHALL be
